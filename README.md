...
| Phase | 目录 | 内容 | 状态 | 预计时长 |
|-------|------|------|------|----------|
| **15** | `15-ast-fundamentals/` | AST 基础（什么是 AST/遍历/操作） | 📝 待开始 | 3-4天 |
| **16** | `16-parser-basics/` | Parser 基础（词法分析/语法分析） | 📝 待开始 | 4-5天 |
| **17** | `17-parser-implementations/` | Parser 实现对比（Acorn/Babel Parser/SWC） | 📝 待开始 | 3-4天 |
